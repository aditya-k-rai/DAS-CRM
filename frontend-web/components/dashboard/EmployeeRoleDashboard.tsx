    ...
    <div className="space-y-6 text-foreground">
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">You have <strong className="text-foreground font-extrabold">5 follow-ups due today</strong> and <strong className="text-foreground font-extrabold">3 deals closing this week</strong>.</p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="crm-card">
          ...
          <p className="text-2xl font-extrabold text-foreground">31 Leads</p>
        ...
        <div className="crm-card">
          ...
          <p className="text-2xl font-extrabold text-indigo-600 dark:text-brand-400">₹5.2L</p>
          <p className="text-xs text-emerald-600 dark:text-emerald-400 font-semibold mt-1">12 Deals Won</p>
        </div>
        <div className="crm-card">
          <p className="text-xs text-muted-foreground font-medium mb-1">My Conversion Rate</p>
          <p className="text-2xl font-extrabold text-emerald-600 dark:text-emerald-400">38.7%</p>
          <p className="text-xs text-emerald-600 dark:text-emerald-400 font-semibold mt-1">↑ +5.2% personal best</p>
        </div>
        <div className="crm-card">
          <p className="text-xs text-muted-foreground font-medium mb-1">My Tasks Due Today</p>
          <p className="text-2xl font-extrabold text-amber-600 dark:text-amber-400">5 Tasks</p>
          <p className="text-xs text-amber-600 dark:text-amber-400 font-semibold mt-1">High Priority</p>
        </div>
      </div>
            ...
            {[
              ...
              <div key={t.title} className="flex items-center justify-between p-3 rounded-xl border border-border bg-background">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">{t.lead} · <Clock size={11} className="inline mr-1" />{t.time}</p>
                </div>
                <span className="text-[10px] px-2 py-0.5 rounded font-bold bg-amber-500/15 text-amber-700 dark:text-amber-400">
                  {t.priority}
                </span>
              </div>
            ))}
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={l.name} className="flex items-center justify-between p-3 rounded-xl border border-border bg-background">
                <div>
                  <Link href="/leads/1" className="font-bold text-sm text-foreground hover:underline">
                    {l.name}
                  </Link>
                  <p className="text-xs text-muted-foreground">{l.val} · Status: {l.status}</p>
                </div>
                <span className="text-xs font-extrabold px-2.5 py-1 rounded bg-emerald-500/15 text-emerald-700 dark:text-emerald-400">
                  🔥 {l.score}
                </span>
              </div>
            ))}
