...
export const SAMPLE_CONTACT_HISTORY: ContactAttempt[] = [
  ...
  },
  {
    ...
    by: 'Priya Sharma (TL A)',
    byRole: 'TEAM_LEADER',
    timestamp: '2026-08-20T11:30:00+05:30',
    durationSeconds: 142,
    notes: 'Supervisor follow-up call. Client reviewed the proposal. Interested but wants to confirm with CFO. Asked about GST invoice process and annual plan discount.',
    productInterest: 'DAS CRM Enterprise Suite',
