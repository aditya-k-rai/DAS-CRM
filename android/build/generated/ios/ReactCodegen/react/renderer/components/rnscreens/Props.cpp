...
#endif
RNSScrollToTopGuardProps::RNSScrollToTopGuardProps(
    const PropsParserContext &context,
    const RNSScrollToTopGuardProps &sourceProps,
    const RawProps &rawProps): ViewProps(context, sourceProps, rawProps)

     {}
    
#ifdef RN_SERIALIZABLE_STATE
ComponentName RNSScrollToTopGuardProps::getDiffPropsImplementationTarget() const {
  return "RNSScrollToTopGuard";
}

folly::dynamic RNSScrollToTopGuardProps::getDiffProps(
    const Props* prevProps) const {
  static const auto defaultProps = RNSScrollToTopGuardProps();
  const RNSScrollToTopGuardProps* oldProps = prevProps == nullptr
      ? &defaultProps
      : static_cast<const RNSScrollToTopGuardProps*>(prevProps);
  if (this == oldProps) {
    return folly::dynamic::object();
  }
  folly::dynamic result = HostPlatformViewProps::getDiffProps(prevProps);
...
RNSModalScreenProps::RNSModalScreenProps(
    ...
    iosOrientationInheritanceFixEnabled(convertRawProp(context, rawProps, "iosOrientationInheritanceFixEnabled", sourceProps.iosOrientationInheritanceFixEnabled, {true})) {}
...
folly::dynamic RNSModalScreenProps::getDiffProps(
  ...
  if (iosOrientationInheritanceFixEnabled != oldProps->iosOrientationInheritanceFixEnabled) {
    result["iosOrientationInheritanceFixEnabled"] = iosOrientationInheritanceFixEnabled;
  }
  return result;
}
#endif
