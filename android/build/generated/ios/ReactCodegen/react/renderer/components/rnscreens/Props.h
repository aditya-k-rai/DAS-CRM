...
class RNSScrollToTopGuardProps final : public ViewProps {
 public:
  RNSScrollToTopGuardProps() = default;
  RNSScrollToTopGuardProps(const PropsParserContext& context, const RNSScrollToTopGuardProps &sourceProps, const RawProps &rawProps);
...
#pragma mark - Props
  ...
  bool iosOrientationInheritanceFixEnabled{true};
