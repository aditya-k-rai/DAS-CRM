...
JSI_EXPORT extern const char RNSScrollToTopGuardComponentName[];

/*
 * `ShadowNode` for <RNSScrollToTopGuard> component.
 */
using RNSScrollToTopGuardShadowNode = ConcreteViewShadowNode<
    RNSScrollToTopGuardComponentName,
    RNSScrollToTopGuardProps,
    RNSScrollToTopGuardEventEmitter,
    RNSScrollToTopGuardState>;
