...
const styles = StyleSheet.create({
  ...
  roleTag: { backgroundColor: 'rgba(192, 132, 252, 0.18)', borderWidth: 1.5, borderColor: 'rgba(192, 132, 252, 0.5)', paddingHorizontal: 12, paddingVertical: 8, borderRadius: 12, flexShrink: 1, maxWidth: '60%' },
