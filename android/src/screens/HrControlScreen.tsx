...
const styles = StyleSheet.create({
  ...
  roleTag: { backgroundColor: 'rgba(56, 189, 248, 0.18)', borderWidth: 1.5, borderColor: 'rgba(56, 189, 248, 0.5)', paddingHorizontal: 12, paddingVertical: 8, borderRadius: 12, flexShrink: 1, maxWidth: '60%' },
